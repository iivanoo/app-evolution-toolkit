...
public class intro_cheats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_intro_cheats);

        View cheatsintroimage = findViewById(R.id.rel_cheats);
        Drawable background = cheatsintroimage.getBackground();
        background.setAlpha(100);

        textintro= (TextView) findViewById(R.id.textintrocheats);
        textdetails= (TextView) findViewById(R.id.textintro_cheatdetails);

        textintro.startAnimation(
                AnimationUtils.loadAnimation(getApplicationContext(), R.anim.fade));
        textdetails.startAnimation(
