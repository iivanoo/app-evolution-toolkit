...
public class cheats_content extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cheats_content);

        Intent intent= getIntent();
        int index=intent.getIntExtra("index", 0);
        frag2 f2= (frag2) getFragmentManager().findFragmentById(R.id.fragment2);
        if(f2!=null)
            f2.changeData(index);
