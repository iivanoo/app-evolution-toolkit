...
public class onest_content extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_onest_content);

        Intent intent= getIntent();
        int index=intent.getIntExtra("index", 0);
        frag2_honest fr2= (frag2_honest) getFragmentManager().findFragmentById(R.id.fragment_honest2);
        if(fr2!=null)
