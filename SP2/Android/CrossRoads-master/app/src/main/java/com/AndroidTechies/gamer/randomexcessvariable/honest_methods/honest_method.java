...
public class honest_method extends AppCompatActivity implements frag1_honest.communicator{
    frag1_honest fr1;
    frag2_honest fr2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honest_list);
        manager=getFragmentManager();
        fr1= (frag1_honest) manager.findFragmentById(R.id.fragment_honest1);
        fr1.setCommunicator(this);
    }

    @Override
    public void respond(int index) {
        fr2= (frag2_honest) manager.findFragmentById(R.id.fragment_honest2);
        if (fr2!=null&&fr2.isVisible())
        {
            fr2.changeData(index);
        }
        else
        {    /* change*/
            Intent inten=new Intent(honest_method.this, onest_content.class);
            inten.putExtra("index", index);
            startActivity(inten);
        }
    }
